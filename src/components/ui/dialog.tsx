...
const dialogStyles = tv({
	slots: {
		...
		footer:
			"mt-auto flex flex-col justify-between gap-3 pb-4 sm:pb-6 pt-4 sm:flex-row",
		closeIndicator:
...
const Close = ({
	...
	// biome-ignore lint/style/noNonNullAssertion: This is the code from https://getjustd.com
