	...
	return (
		<ToasterPrimitive
			...
			toastOptions={{
				...
				classNames: {
					toast: twJoin(
						"bg-bg ring-1 ring-border dark:ring-inset sm:min-w-[22rem] rounded-xl text-fg overflow-hidden text-[0.925rem] backdrop-blur-xl px-4 py-3 font-normal sm:px-5 sm:py-5 font-sans",
